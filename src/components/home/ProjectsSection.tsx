    ...
    >
      ...
      <div className="flex flex-col items-start gap-[10px] w-full">
        ...
        <p className="text-[14px] leading-[20px] text-black/60 w-full min-h-[40px] line-clamp-2">
          <span className="lang-en">{project.shortDescription || project.projectOverview}</span>
          <span className="lang-ta">{project.shortDescriptionTa || project.projectOverviewTa || project.shortDescription || project.projectOverview}</span>
        </p>
      </div>
